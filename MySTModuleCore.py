...
class MySTModuleCore(MySTModule):
	...
	def getCoreFunctions(self):
		return {
				'env':['user', 'super'],    # Environment Variables
				'escope':['user', 'super'], # User escope
				'contacts':['super']        # Contact manager
			   }
	...
	def execute(self, instruct):
        ...
        # Information about MyST
			...
			info  = "MyServerTalks! - %s\n" % MySTBase.getVersion()
			info += "Web Page: www.myservertalks.com\n"
			info += "Process ID: %s\n" % os.getpid()
